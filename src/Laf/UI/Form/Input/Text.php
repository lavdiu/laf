...
class Text implements FormElementInterface, ComponentInterface
{
    ...
    public function drawViewMode()
    {
        ...
        $this->addCssClass('bg-light')
            ...
            ->addCssClass('p-2');
        $html = "
        <div id='{$this->getId()}_container' style='min-width:0;{$this->getWrapperCssStyleForHtml()}' class='mb-3 {$this->getFormRowDisplayMode()} {$this->getWrapperCssClassesForHtml()} " . ($this->isHidden() || $this->hasCssClass('d-none') ? " d-none" : "") . "'>
            ...
            " . ($this->getFormRowDisplayMode() == 'row' ? "<div class='col-sm-10'>" : "") . "
                <div id='{$this->getId()}' class='{$this->getCssClassesForHtml()}' style='max-width:100%;overflow-wrap:break-word;word-break:break-all;{$this->getCssStyleForHtml()}' {$params} >" . ($this->getValueForHtml() != "" ? $this->getValueForHtml() : "&nbsp;") . "</div>
