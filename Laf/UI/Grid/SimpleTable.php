	...
	public function toHTML(): string
	{
		...
		foreach ($columnsFromDb as $name => $value) {
			if (is_array($manualColumns) && !array_key_exists($name, $manualColumns)) {
				...
				if (array_key_exists('visible', $manualColumns) && !$manualColumns['visible']) {
...
\t</thead>";
	...
	public function getFooterRow()
	{
		...
		$html .= "\n\t\t\t\t\t<li class='page-item'><a href='{$this->getTableUrl()}{$questionMark}&page=1' class='page-link'><i class='fa fa-angle-double-left'></i></a></li>";
		$html .= "\n\t\t\t\t\t<li class='page-item " . ($this->hasPreviousPage() ? '' : 'disabled') . "'><a href='{$this->getTableUrl()}{$questionMark}&page=" . ($this->getCurrentPage() - 1) . "' class='page-link'><i class='fa fa-angle-left'></i></a></li>";
		...
		$html .= "\n\t\t\t\t\t<li class='page-item " . ($this->hasNextPage() ? '' : 'disabled') . "'><a href='{$this->getTableUrl()}{$questionMark}&page=" . ($this->getCurrentPage() + 1) . "' class='page-link'><i class='fa fa-angle-right'></i></a></li>";
		$html .= "\n\t\t\t\t\t<li class='page-item'><a href='{$this->getTableUrl()}{$questionMark}&page={$this->getTotalPages()}' class='page-link'><i class='fa fa-angle-double-right'></i></a></i>";
		$html .= "\n\t\t\t\t</ul>";
		$html .= "\n\t\t\t\t</nav>";
		$html .= "\n\t\t\t</td>\n\t\t</tr>";
		$html .= "\n\t</tfoot>\n";
		...
		if ($this->tableUrl == '') {
			...
			foreach ($_GET as $key => $value) {
				if ($key == 'uriRewrite') {
					...
					$this->tableUrl .= ($this->tableUrl == '?' ? '' : '&') . $key . '=' . $value;
				}
			}
		}
