...
\t</thead>";
	...
	public function getFooterRow()
	{
		...
		$html .= "\n\t\t\t\t<li class='page-item'><a href='{$this->getTableUrl()}{$questionMark}&page=1' class='page-link'><i class='fa angle-double-left'></a></li>";
		...
		$html .= "\n\t\t\t\t<li class='page-item'><a href='{$this->getTableUrl()}{$questionMark}&page={$this->getTotalPages()}' class='page-link'><li class='fa arrow-double-right'></a></li>";
		$html .= "\n\t\t\t\t</ul>";
		$html .= "\n\t\t\t\t</nav>";
		$html .= "\n\t\t\t</td>\n\t\t</tr>";
		$html .= "\n\t</tfoot>\n";
